<template>
    <div>
                            ...
                            <ul>
                                <li v-for="(item, index) in catelist" :key="item.id">
                                    <h3>
                                        ...
                                        <p>
                                            <span v-for="(cate, index) in item.subcates" :key="cate.id">
                                                {{cate.title}}&nbsp;
                                            </span>
                                            <!-- <span>
                                                摄影摄像&nbsp;
                                    ...
                                    <div class="item-box">
                                        <dl>
                                            ...
                                            <dd>
                                                <a v-for="(cate, index) in item.subcates" :key="cate.id" href="/goods/43.html">{{cate.title}}</a>
                                            </dd>
                                        </dl>
                                    </div>
                                </li>
        ...
        <div v-for="(messages, index) in message" :key="messages.level1cateid" class="section">
            <div class="main-tit">
                <h2>{{messages.catetitle}}</h2>
                <p>
                    <a v-for="(level2catelists, index) in messages.level2catelist" :key="level2catelists.subcateid" href="/goods/43.html">{{level2catelists.subcatetitle}}</a>
            ...
            <div class="wrapper clearfix">
                <div class="wrap-box">
                    <ul class="img-list">
                        <li v-for="(data, index) in messages.datas" :key="data.artID">
...
export default {
    ...
    created:function(){
        axios.get('http://111.230.232.110:8899/site/goods/gettopdata/goods').then(data=>{
        ...
        axios.get('http://111.230.232.110:8899/site/goods/getgoodsgroup').then(data=>{
